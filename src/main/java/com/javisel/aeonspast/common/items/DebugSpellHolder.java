...
public class DebugSpellHolder extends TrinketItem {
    public DebugSpellHolder( ) {
        super(TrinketEnums.AMULET, new Properties().stacksTo(1), new APItemProperties(APItemRarity.COMMON), SpellRegistration.HOP);
    }
}
