package com.javisel.aeonspast.common.items.weapons.vanillaoverride;
...
public class OverrideCrossbow extends ProjectileWeaponItem implements Vanishable {
    ...
    public OverrideCrossbow(Item.Properties p_40850_) {
        super(p_40850_);
    }
    ...
    private static void shootProjectile(Level level, LivingEntity entity, InteractionHand hand, ItemStack stack, ItemStack projectileStack, float p_40900_, boolean p_40901_, float p_40902_, float p_40903_, float p_40904_) {
        if (!level.isClientSide) {
            boolean flag = projectileStack.is(Items.FIREWORK_ROCKET);
            Projectile projectile;
            if (flag) {
                projectile = new FireworkRocketEntity(level, projectileStack, entity, entity.getX(), entity.getEyeY() - (double) 0.15F, entity.getZ(), true);
            } else {
                projectile = getArrow(level, entity, stack, projectileStack);
