...
public class DamageInstance {
    ...
    public static DamageInstance getBurnDamage(double amount) {

        DamageInstance instance = getGenericProcDamage(DamageTypeEnum.BURN, amount);

        instance.isOverTime = true;
       instance. isMagic = true;
    ...
    public boolean doesDeviceMatch(Object damageDevice) {
        ...
        if (damageDevice instanceof SpellStack) {
            System.out.println("Spell device");
        ...
        if (damageDevice instanceof ItemStack) {
            System.out.println("Item Device");
