...
public class ItemPropertyRegistration {
    ...
    public static final RegistryObject<ItemProperty> GILDED = ITEM_PROPERTIES.register("gilded", () -> new com.javisel.aeonspast.common.items.properties.weapon.Gilded());
    ...
    public static final RegistryObject<ItemProperty> KINETIC = ITEM_PROPERTIES.register("versatile", () -> new Kinetic());
