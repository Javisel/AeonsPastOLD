...
public class EntityTypeRegistration {
    ...
    public static  final RegistryObject<EntityType<?>> THROWN_AXE = ENTITY_TYPES.register("thrown_axe",() ->EntityType.Builder.of(AxeEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).build(AeonsPast.MODID + ":thrown_axe"));
